...
test.describe('ConfirmationModal', () => {
    test('Default visual regression', async ({ page }) => {
        ...
        await expect(page.locator('.uksf-theme')).toHaveScreenshot('confirmation-default.png');
    });
    ...
    test('Custom title visual regression', async ({ page }) => {
        ...
        await page.waitForSelector('mat-dialog-actions');
        await expect(page.locator('.uksf-theme')).toHaveScreenshot('confirmation-custom-title.png');
    });
    ...
    test('HTML content visual regression', async ({ page }) => {
        ...
        await page.waitForSelector('mat-dialog-actions');
        await expect(page.locator('.uksf-theme')).toHaveScreenshot('confirmation-html-content.png');
    });
});
