...
test.describe('ValidationReportModal', () => {
    test('Single message visual regression', async ({ page }) => {
        ...
        await expect(page.locator('.uksf-theme')).toHaveScreenshot('validation-report-single.png');
    });
    ...
    test('Error message visual regression', async ({ page }) => {
        ...
        await page.waitForSelector('mat-dialog-actions');
        await expect(page.locator('.uksf-theme')).toHaveScreenshot('validation-report-error.png');
    });
    ...
    test('Multiple messages visual regression', async ({ page }) => {
        ...
        await page.waitForSelector('mat-dialog-actions');
        await expect(page.locator('.uksf-theme')).toHaveScreenshot('validation-report-multiple.png');
    });
});
