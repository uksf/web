...
test.describe('Paginator', () => {
    test('Default visual regression', async ({ page }) => {
        ...
        await expect(page.locator('.uksf-theme')).toHaveScreenshot('paginator-default.png');
    });
    ...
    test('Small dataset visual regression', async ({ page }) => {
        ...
        await page.waitForSelector('.paginator-container');
        await expect(page.locator('.uksf-theme')).toHaveScreenshot('paginator-small.png');
    });
    ...
    test('Large dataset visual regression', async ({ page }) => {
        ...
        await page.waitForSelector('.paginator-container');
        await expect(page.locator('.uksf-theme')).toHaveScreenshot('paginator-large.png');
    });
});
