import { EventEmitter, NgZone, OnDestroy, Component, Input, Output, Renderer2, ViewChild, ElementRef } from '@angular/core';
import { Subscription, timer } from 'rxjs';
import { UploadFile, UploadEvent } from '../../Services/fileUploadTypes.service';
