...
function buildForm(allChecked = false) {
    const value = allChecked ? 'checked' : '';
    return new FormGroup({
        playstyle: new FormControl(value, Validators.required),
        dedication: new FormControl(value, Validators.required),
        days: new FormControl(value, Validators.required),
        loa: new FormControl(value, Validators.required),
        arma: new FormControl(value, Validators.required),
        rules: new FormControl(value, Validators.required)
    });
}
...
const template = `
    <mat-card>
        ...
        <form [formGroup]="formGroup">
            <h3>Please read and confirm the following information</h3>
            By applying to join UKSF, you are confirming you understand the information presented below.
            <br />
            <br />
            <div>
                <h4>Playstyle</h4>
                ...
                <mat-checkbox color="primary" formControlName="playstyle">I confirm I understand the UKSF playstyle</mat-checkbox>
            </div>
            <br />
            <div>
                <h4>Dedication</h4>
                ...
                <mat-checkbox color="primary" formControlName="dedication">I confirm I understand the dedication required</mat-checkbox>
            </div>
            <br />
            <div>
                <h4>Days we play</h4>
                ...
                <mat-checkbox color="primary" formControlName="days">I confirm I can attend Main Ops and Training regularly</mat-checkbox>
            </div>
            <br />
            <div>
                <h4>Absence</h4>
                ...
                <mat-checkbox color="primary" formControlName="loa">I confirm I understand the LOA system</mat-checkbox>
            </div>
            <br />
            <div>
                <h4>Arma</h4>
                ...
                <mat-checkbox color="primary" formControlName="arma">I confirm I am able to play Arma</mat-checkbox>
            </div>
            <br />
            <div>
                ...
                <mat-checkbox color="primary" formControlName="rules">I confirm I understand the unit rules</mat-checkbox>
            </div>
            <br />
            <br />
...
export const Default: Story = {
    render: () => ({
        props: { formGroup: buildForm(false) },
        styles,
        template
    })
};
...
export const AllChecked: Story = {
    render: () => ({
        props: { formGroup: buildForm(true) },
        styles,
        template
    })
};
