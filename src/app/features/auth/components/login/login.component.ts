...
@Component({
    ...
    imports: [MatDialogTitle, FormsModule, TextInputComponent, ButtonHiddenSubmitComponent, MatCheckbox, FlexFillerComponent, ButtonComponent, TemplateFormValueDebugComponent]
})
